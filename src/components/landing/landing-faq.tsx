...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "ありません。国試対策パックは買い切り型なので、最初の1回のお支払いだけで完了します。サブスクリプションではないので、解約手続きや延長課金は発生しません。受験年度の試験翌月までご利用いただけます。",
  },
  {
    q: "年度の途中から国試対策パックを購入できますか？",
    a: "はい。いつご購入いただいても、その年度の試験翌月までご利用いただけます。早く始めるほど、1日あたりのコストは下がります。",
  },
  {
    q: "卒業後もデータは見られますか？",
