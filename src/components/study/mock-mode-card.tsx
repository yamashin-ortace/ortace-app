...
export function MockModeCard({ plan }: { plan: PlanType }) {
  ...
  return (
    <Link
      ...
      className={
        isExamPlan
          ? "flex items-center gap-3 rounded-[16px] border border-[var(--primary)]/35 bg-[var(--bg-card)] p-4 text-[var(--text-1)] shadow-[0_2px_8px_rgba(0,0,0,0.05)] transition-[transform,box-shadow,border-color] duration-200 ease-out hover:-translate-y-px hover:border-[var(--primary)]/55 hover:shadow-[0_5px_16px_rgba(0,0,0,0.08)]"
          : "flex items-center gap-3 rounded-[16px] border border-dashed border-[var(--primary-dark)]/45 bg-[var(--bg-muted)]/65 p-4 text-[var(--text-1)] shadow-[inset_0_0_0_1px_rgba(255,255,255,0.28)] transition-[transform,box-shadow,border-color] duration-200 ease-out hover:-translate-y-px hover:border-[var(--primary-dark)]/65 hover:shadow-[0_5px_16px_rgba(0,0,0,0.07)]"
      }
    >
      <span
        className={
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        <div className="flex flex-wrap items-center gap-x-2 gap-y-1">
          ...
          <span
            className={
              isExamPlan
                ? "inline-flex items-center rounded-full border border-[var(--primary)]/35 bg-[var(--primary-soft)] px-2 py-0.5 text-[10px] font-extrabold text-[var(--primary-dark)]"
