        ...
        <div className="flex min-w-0 flex-1 flex-col gap-2">
          <div>
            <p className="text-[14px] font-extrabold text-[var(--text-1)]">
              {isSkipped
                ? `初回診断（${DIAGNOSTIC_QUESTION_COUNT}問）をまだ受けられます`
                : `おすすめ：今の自分の位置を知る初回診断（${DIAGNOSTIC_QUESTION_COUNT}問）`}
            </p>
            <p className="mt-0.5 text-[12px] leading-relaxed text-[var(--text-2)]">
              {isSkipped
                ? "苦手分野と慎重推定スコアの土台がわかり、毎日の優先度が決めやすくなります。先に自分で進めて問題ありません。"
                : "9分野から3問ずつ。受けると苦手分野と慎重推定スコアの初期値が分かり、毎日の優先度が決まります。あとから受けることもできます。"}
            </p>
          </div>
