...
export function OriginalQuestionPreviewCard() {
  return (
    <div
      className="flex items-center gap-3 rounded-[16px] border border-[var(--primary)]/25 bg-[var(--bg-card)] p-4 text-[var(--text-1)] shadow-[0_2px_8px_rgba(0,0,0,0.04)]"
      aria-label="オリジナル問題は準備中です"
    >
