...
import { ReviewQueueSelectionCopy } from "@/components/study/review-queue-selection-copy";
...
export function ReviewQueueHowItWorksPopover({ className }: Props) {
  return (
    <Popover.Root>
      <Popover.Trigger
        type="button"
