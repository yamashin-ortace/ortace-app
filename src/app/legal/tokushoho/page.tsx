    ...
    >
      <table className="legal-table">
        <tbody>
          ...
          <tr>
            <th>支払時期</th>
            <td>有料プランの無料トライアルは、1アカウントにつき1回に限り14日間ご利用いただけます。無料期間中にキャンセルがない場合、15日目に登録の支払方法から決済されます。プラン変更または再購入時に無料トライアルは再付与されません。</td>
          </tr>
          <tr>
            <th>商品（サービス）の引渡時期</th>
            <td>初回のお申し込み後、14日間の無料トライアルを直ちにご利用いただけます。無料期間終了後も継続する場合は、決済完了後に有料プランとして引き続きご利用いただけます。無料トライアルを利用済みの場合は、お申し込み後に決済されます。</td>
          </tr>
          <tr>
            <th>返品・キャンセル</th>
            <td>
