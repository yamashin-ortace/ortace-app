...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "チャットで会話する機能ではなく、回答履歴・正答率・解いた感覚・解答時間をもとに、今日やるべき問題や確認テーマを提案する学習コーチ機能です。",
  },
  {
    q: "スマートフォンだけで使えますか？",
  ...
  {
    q: "初回14日間無料トライアルはありますか？",
    a: "はい。基礎定着パスと国試対策パックは、初回14日間無料トライアルの対象です。お申し込み時に支払方法を登録し、期間中にキャンセルしなければ15日目に選択したプランの料金が自動で決済されます。プランを変更した場合や再度購入する場合、無料トライアルは再付与されません。利用期間終了後の自動更新はありません。",
  },
  {
    q: "使える決済方法は？",
  ...
  },
  {
    ...
    a: "ありません。国試対策パックは初回14日間無料トライアル後に1回だけ決済され、受験年度の3月31日までご利用いただけます。期間終了後の自動更新や延長課金はありません。",
  },
  {
