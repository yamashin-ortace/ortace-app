...
import { WeakFieldSelectionCopy } from "@/components/study/weak-field-selection-copy";
...
export function WeakFieldHowItWorksPopover({ className }: Props) {
  return (
    <Popover.Root>
      <Popover.Trigger
        type="button"
