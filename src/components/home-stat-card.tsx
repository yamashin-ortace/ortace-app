...
const ROW_LABEL =
  "flex min-h-7 w-full items-center gap-1.5 text-[12px] font-semibold text-[var(--text-3)]";
const ROW_VALUE = "mt-1 flex w-full min-w-0 items-baseline justify-start gap-1";
